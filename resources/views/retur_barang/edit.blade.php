        ...
        <form action="{{ route('retur-barang.update', $returBarang->id) }}" method="POST">
            ...
            <div class="mb-6">
                <div class="mb-6">
                    ...
                    <select id="id_user" name="id_user" class="p-3 bg-white mt-1 block w-full pl-3 pr-10 py-2 text-base focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md {{ $errors->has('id_user') ? 'border-red-500' : 'border-gray-300' }}">
                        <option value="">Pilih Pelapor</option>
                        @foreach($users as $user)
                            <option value="{{ $user->id }}" {{ old('id_user', $returBarang->id_user) == $user->id ? 'selected' : '' }}>{{ $user->nama }}</option>
                        @endforeach
                    </select>
                    @error('id_user')
                ...
                <div class="mb-6">
                    ...
                    <select id="id_status_retur" name="id_status_retur" class="p-3 bg-white mt-1 block w-full pl-3 pr-10 py-2 text-base focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md {{ $errors->has('id_status_retur') ? 'border-red-500' : 'border-gray-300' }}">
