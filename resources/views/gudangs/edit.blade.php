    ...
    <div class="bg-white rounded-lg shadow-md p-6 w-2xl mx-auto">
        ...
        <form action="{{ route('gudangs.update', $gudang->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_gudang" id="nama_gudang" value="{{ old('nama_gudang', $gudang->nama_gudang) }}" 
            ...
            <div class="mb-6">
                ...
                <input type="text" name="lokasi" id="lokasi" value="{{ old('lokasi', $gudang->lokasi) }}" 
                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" 
                    required>
            </div>

            <div class="flex items-center justify-between">
                <a href="{{ route('gudangs.show', $gudang->id) }}" class="text-blue-600 hover:text-blue-800 font-medium">
                    &larr; Kembali
                </a>
