                            ...
                            <div class="bg-white p-6 rounded-lg shadow-sm">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <p class="text-base text-gray-900">{{ Auth::user()->id }}</p>
                                    </div>
                                    
                                    <div>
                                        <p class="text-sm font-medium text-gray-500">Nama</p>
                                        <p class="text-base text-gray-900">{{ Auth::user()->nama_user }}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base text-gray-900">{{ Auth::user()->role->nama_role }}</p>
                                    </div>
