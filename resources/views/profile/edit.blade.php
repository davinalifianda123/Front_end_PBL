                                ...
                                <div class="bg-white p-6 rounded-lg shadow-sm">
                                    ...
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <input type="text" id="id" value="{{ Auth::user()->id }}" class="mt-1 p-2 w-full bg-gray-100 text-gray-900 rounded-md" disabled>
                                        </div>
                                        
                                        <div>
                                            <label for="nama_user" class="text-sm font-medium text-gray-500">Nama</label>
                                            <input type="text" id="nama_user" name="nama_user" value="{{ old('nama_user', Auth::user()->nama_user) }}" class="mt-1 p-2 w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                            @error('nama_user')
                                        ...
                                        <div>
                                            ...
                                            <input type="email" id="email" value="{{ Auth::user()->email }}" class="mt-1 p-2 w-full bg-gray-100 text-gray-900 rounded-md" disabled>
                                        </div>
                                        
                                        <div>
                                            <label for="role" class="text-sm font-medium text-gray-500">Role</label>
                                            <input type="text" id="role" value="{{ Auth::user()->role->nama_role }}" class="mt-1 p-2 w-full bg-gray-100 text-gray-900 rounded-md" disabled>
                                        </div>
                                    ...
                                    <div class="mt-6 pt-6 border-t border-gray-200">
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-base text-gray-900">{{ Auth::user()->updated_at->format('d M Y') }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
